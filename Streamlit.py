...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "kL6tP3xM1eN"         # 用户名
UUID = "f4b31b77-3634-4254-9a85-91d4b3e1c6ec"                     # UUID，留空则自动生成
PORT = 41818                   # Vmess端口，留空或0则自动生成
DOMAIN = "sl.hilink.dpdns.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiODYwMzYyNmRiMmE3MTgxMDBiMmRkNzcwNTg4MWVmMDAiLCJ0IjoiMzIxMzM1MTYtZjM3YS00MTZkLThlZjItZjdiZTQ5MDc2N2MyIiwicyI6Ik56VXdNems0WVRJdE16ZGtZaTAwTXpJd0xXSXpNbUl0TTJRM01EZGtNRGswTkRReiJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
...
# 上传订阅到API服务器
UPLOAD_API = "https://web.hilink.dpdns.org/api/upload.php"  # 文件上传API
